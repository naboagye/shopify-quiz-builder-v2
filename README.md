This is an example [Shopify CLI](https://shopify.dev/apps/tools/cli) project for building a Shopify quiz app using [Gadget](https://gadget.dev) as a backend.

## What's in here

This app allows you to create new product quizzes on a Shopify store's Admin page, and stores all quiz data in a Gadget application. The following is already set up:

- the connection to the Gadget backend is installed using the API client package for an example app (`@gadget-client/product-quiz-v2`)
...
```shell
npx create-next-app@latest --example https://github.com/gadget-inc/examples --example-path packages/product-recommendations-quiz-app/product-quiz-admin
# or
yarn create next-app --example https://github.com/gadget-inc/examples --example-path packages/product-recommendations-quiz-app/product-quiz-admin
# or
pnpm create next-app --example https://github.com/gadget-inc/examples --example-path packages/product-recommendations-quiz-app/product-quiz-admin
```
...
[![Fork on Gadget](https://assets.gadget.dev/assets/fork-button.svg)](https://app.gadget.dev/auth/fork?domain=product-quiz-v2.gadget.app)
...
import { Client } from "@gadget-client/product-quiz-v2";
// to:
...
- [Gadget's embedded app documentation](https://docs.gadget.dev/guides/connections/shopify-app-frontends)
...
The easiest way to deploy your Shopify CLI app is to follow our docs for deploying on [Vercel, Netlify, or Heroku](https://docs.gadget.dev/guides/frontend-deployment).

Shopify also has deployment docs for [Heroku and Fly.io](https://shopify.dev/apps/deployment/web).
